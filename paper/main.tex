...
\paragraph{Reproducibility.} The preregistrations (with dated amendments),
findings documents, panel adjudications, caches, summary results and analysis
code for the experiments reported here are in the program repository; the
trained solver checkpoints and the per-instance records, too large for it, are
in the archived deposit. Numbers tied to a preregistered
